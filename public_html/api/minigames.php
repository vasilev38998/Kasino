...
update_mission_progress((int) $user['id'], 'minigame_plays', 1);
if ($win > 0) {
    update_mission_progress((int) $user['id'], 'minigame_win', $win);
}
update_tournament_progress((int) $user['id'], 'minigames', $bet, $win);
